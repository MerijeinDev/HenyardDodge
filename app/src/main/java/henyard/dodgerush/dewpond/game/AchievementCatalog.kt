...
object AchievementCatalog {
    ...
    val items: List<Achievement> = listOf(
        ...
        Achievement("untouchable", R.string.ach_untouchable, R.string.ach_untouchable_desc, 1) { 0 },
        Achievement("grain_eater", R.string.ach_grain_eater, R.string.ach_grain_eater_desc, 5000) { 0 },
        Achievement("survivor", R.string.ach_survivor, R.string.ach_survivor_desc, 1800) { 0 },
        Achievement("close_call", R.string.ach_close_call, R.string.ach_close_call_desc, 1000) { 0 },
        ...
        Achievement("shielded", R.string.ach_shielded, R.string.ach_shielded_desc, 100) { 0 },
        Achievement("coin_dodger", R.string.ach_coin_dodger, R.string.ach_coin_dodger_desc, 5000) {
            it.coins.coerceAtMost(5000)
        },
        Achievement("fox_foiler", R.string.ach_fox_foiler, R.string.ach_fox_foiler_desc, 200) { 0 },
    )
}
